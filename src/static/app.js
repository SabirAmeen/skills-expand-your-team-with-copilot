document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty) {
        // Show activities matching the selected difficulty, or those with no
        // difficulty set (they are suitable for all levels)
  ...
  function renderActivityCard(name, details) {
    ...
    // Create activity tag
    const tagHtml = `
      <span class="activity-tag" data-category="${activityType}" style="background-color: ${typeInfo.color}; color: ${typeInfo.textColor}">
        ${typeInfo.label}
      </span>
    `;
